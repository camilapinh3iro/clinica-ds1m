...
public class HomeFrame extends javax.swing.JFrame {
    ...
    public HomeFrame() {
        ...
        MedicoDAO.getListaEsoecialidades();
        initPanels();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/senai/sp/jandira/imagens/agendamento.png"))); // NOI18N
        jPanel1.add(jLabel2);
        ...
        buttonSair.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/senai/sp/jandira/imagens/exit-door.png"))); // NOI18N
        ...
        buttonAgenda.setForeground(new java.awt.Color(246, 246, 246));
        ...
        buttonPlanosDeSaude.setForeground(new java.awt.Color(246, 246, 246));
        buttonPlanosDeSaude.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/senai/sp/jandira/imagens/card.png"))); // NOI18N
        ...
        buttonPacientes.setForeground(new java.awt.Color(246, 246, 246));
        buttonPacientes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/senai/sp/jandira/imagens/paciente32.png"))); // NOI18N
        ...
        buttonMedicos.setForeground(new java.awt.Color(246, 246, 246));
    ...
    private void buttonHomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonHomeActionPerformed
        mudarCorDoBotao();
        buttonHome.setBackground(new java.awt.Color(51, 204, 0));

        mudarEstadoPainelFalse();
    ...
    private void buttonPlanosDeSaudeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonPlanosDeSaudeActionPerformed
        mudarCorDoBotao();
        buttonPlanosDeSaude.setBackground(new java.awt.Color(51, 204, 0));
    ...
    private void buttonEspecialidadesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEspecialidadesActionPerformed
        mudarCorDoBotao();
        buttonEspecialidades.setBackground(new java.awt.Color(51, 204, 0));
    ...
    private void buttonMedicosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMedicosActionPerformed
        mudarCorDoBotao();
        buttonMedicos.setBackground(new java.awt.Color(51, 204, 0));
    ...
    private void mudarEstadoPainelFalse() {
